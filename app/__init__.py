...
class App:
    def __init__(self):
        # Ensure logs directory is created in a macOS-safe manner
        logs_dir = os.path.join(os.path.expanduser('~'), 'logs')  # Home directory safe for writing logs
        os.makedirs(logs_dir, exist_ok=True)
        self.configure_logging(logs_dir)
    ...
    def configure_logging(self, logs_dir):
